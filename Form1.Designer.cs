...
namespace Dice
{
    public class DiceDesignForm : Form
    {
        private int[] difference = new int[6];
        private int[] pctDifference = new int[6];
        private bool[] accetable = new bool[6];
        private string msgGood = "Conclusion:  this die is GOOD.";
        private string msgBad = "Conclusion:  this die is BAD!";
            ...
            PictureBox[] pictureBoxArray = new PictureBox[6]
      {
        ...
        private void InitializeComponent()
        {
            ...
            this.label1.Text = "Let's Find Out How Reliable This Die Is";
            ...
            this.label2.Text = "Rolling Times:";
            ...
            this.Name = "DiceDesignForm";
            this.Text = "Test A Die";
